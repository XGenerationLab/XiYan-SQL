...
+ `Oct. 20, 2025` 🌟 The training framework of XiYan-SQL, **XiYan-SQLTraining**, will soon be released as open source in the official Alibaba repository of [XiYan-SQL](https://github.com/alibaba/XiYan-SQL). Stay tuned!
+ ...
